 ...
 */
public class HomeScreen1 extends TestSuiteBase {
    ...
    public void AddHomeScreen(String username, String password) throws Exception {
    ...
    @DataProvider
    public Object[][] AddHomeScreen_Test_Data()
    {
        Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Profile","AddHomeScreen");
        return(data);
    }
}
