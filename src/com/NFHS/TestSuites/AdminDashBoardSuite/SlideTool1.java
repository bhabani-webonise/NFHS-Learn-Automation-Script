 ...
 */
public class SlideTool1 extends TestSuiteBase{
    ...
    @Test(dataProvider="SlideTool1_Test_Data")
    public void AddNewSlider1(String username, String password) throws Exception {
    ...
    @DataProvider
    public Object[][] SlideTool1_Test_Data()
    {
        Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Profile","SlideTool1");
        return(data);
    }
}
