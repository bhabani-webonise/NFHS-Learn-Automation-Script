 ...
 */
public class HomeScreen3 extends TestSuiteBase {
...
@Test(dataProvider="HomeScreen3_Test_Data")
    public void EditHomeScreen(String username, String password ) throws Exception {
    ...
    @DataProvider
    public Object[][] HomeScreen3_Test_Data()
    {
        Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Profile","HomeScreen3");
        return(data);
    }
}
