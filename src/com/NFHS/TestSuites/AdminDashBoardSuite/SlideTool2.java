 ...
 */
public class SlideTool2 extends  TestSuiteBase {
    ...
    @Test(dataProvider="SlideTool2_Test_Data")
    public void DeleteSlider1(String username, String password) throws Exception {
    ...
    @DataProvider
    public Object[][] SlideTool2_Test_Data()
    {
        Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Profile","SlideTool2");
        return(data);
    }
}
