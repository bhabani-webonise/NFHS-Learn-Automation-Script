 ...
 */
public class HomeScreen2 extends TestSuiteBase {
    ...
    @Test(dataProvider="RemoveHomeScreen_Test_Data")

    public void RemoveHomeScreen(String username, String password) throws Exception {
    ...
    @DataProvider
    public Object[][] RemoveHomeScreen_Test_Data()
    {
        Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Profile","RemoveHomeScreen");
        return(data);
    }
}