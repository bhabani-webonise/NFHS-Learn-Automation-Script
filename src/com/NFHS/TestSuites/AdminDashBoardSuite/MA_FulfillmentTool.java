package com.NFHS.TestSuites.AdminDashBoardSuite;
...
/**
 * Created by webonise on 25-05-2015.
 */
public class MA_FulfillmentTool extends TestSuiteBase {
    ...
    @Test(dataProvider="AddHomeScreen_Test_Data")
    public void AdminFulfillmentTool(String username, String password) throws Exception {
    ...
    @DataProvider
    public Object[][] ma_FulfillmentTool_Test_Data()
    {
        Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Profile","MA_FulfillmentTool");
        return(data);
    }
