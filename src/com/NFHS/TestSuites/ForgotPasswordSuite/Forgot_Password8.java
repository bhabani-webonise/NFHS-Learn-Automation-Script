...
public class Forgot_Password8 extends TestSuiteBase
{
	...
	@Test(dataProvider="forgot_Password8_Test_Data")
	public void forgot_Password_8(String emailaddress,String gpassword) throws Exception
	{   
	    		...
	    		Set<String> allwindows=driver.getWindowHandles();
	    			...
	    			for(String windowid:allwindows)
	    			{
	    				if(driver.switchTo().window(windowid).getTitle().equals("NfhsLearn"))
	    				{
	    					...
	    					boolean newpwd=pb.webElementProperty("change_new_password").isDisplayed();
	    					boolean confirmpwd=pb.webElementProperty("change_confirm_password").isDisplayed();
	    				    Assert.assertEquals(newpwd,true);
	    				    Assert.assertEquals(confirmpwd,true);
	    				    driver.close();
	    				    break;
	    				}
	    			}
	...
	@DataProvider
	public Object[][] forgot_Password8_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password8");
	    return(data);
	}
}
