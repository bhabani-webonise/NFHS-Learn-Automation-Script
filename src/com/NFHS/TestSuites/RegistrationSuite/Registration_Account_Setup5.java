...
public class Registration_Account_Setup5 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="registration_Account_Setup5_Test_Data")
	       ...
	       try
	          {
	                  ...
	                  String passworderror=rp.registerUserPasswordFieldRequired(emailaddress, confirmemailaddress, password, confirmpassword);
                      Assert.assertEquals(passworderror,"Please enter at least 8 characters.");
	...
	public void reportTestCaseResult() throws InvalidFormatException, IOException
	{
	   ...
	   @DataProvider 
	   public Object[][] registration_Account_Setup5_Test_Data()
	   {
		   Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Registration","Registration_Account_Setup5");
	       return(data);
	   }
}
